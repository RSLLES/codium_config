I use the "local-sync" extension, which simply imports and exports Codium settings from an external folder:   https://open-vsx.org/extension/anweber/local-sync  
